...
swaggerConfig = {
  'headers': [], #las cabeceras que podran aceptar nuestra documentacion
  'specs': [
    {
      'endpoint':'', # el endpoint inicial de nuestra documentacion
      'route': '/' # mi ruta base de mi documentacion (hacia donde hara los request)
    }
  ],
...
def prepararPedido(id):
  ...
  # buscar si el pedido aun no tiene barmanb seleccionado
