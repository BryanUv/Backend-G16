...
# un decorador es la implementacion de una funcion dentro de otra funcion sin la necesidad de llamarlo o ejecutarlo
# dentro de la funcion
def validar_invitado(funcion):
  # wraps -> envuelve la funcion o metodo donde vamos a utilizar esta funcion para devolvernos toda su 
  # configuracion 
  @wraps(funcion)
  def wrapper(*args, **kwargs):
    ...
    # continuara con la configuracion que va debajo del decorador
